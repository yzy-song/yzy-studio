    ...
    <main className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-black via-gray-900 to-purple-900 text-white overflow-hidden perspective-1000">
      ...
      >
        ...
        <motion.section
            ...
            className="w-full max-w-4xl px-4 py-16 text-center z-10"
        >
            <h2 className="text-4xl font-extrabold mb-4 text-pink-400">About Me</h2>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <p className="text-xl text-gray-400 mb-6">
              I am a Full-Stack Software Engineer specializing in architecting and developing high-performance, scalable web applications. My focus is on creating robust systems with exceptional user experiences.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10 w-full max-w-6xl px-4">
          {projects.map((p, i) => (
            ...
            >
              <Link 
                href={`/projects/${p.slug}`} // <-- 跳转到新的架构详情页
                passHref
                legacyBehavior
              >
